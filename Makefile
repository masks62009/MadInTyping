#############################################################################
# Makefile for building: Type.app/Contents/MacOS/Type
# Generated by qmake (2.01a) (Qt 4.6.0) on: ?? 12? 27 13:42:53 2009
# Project:  Type.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.6/mkspecs/macx-g++ -macx -o Makefile Type.pro
#############################################################################
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		boshiamy.cpp moc_mainwindow.cpp \
		qrc_boshiamy.cpp
OBJECTS       = main.o \
		mainwindow.o \
		boshiamy.o \
...
QMAKE_TARGET  = Type
DESTDIR       = 
TARGET        = Type.app/Contents/MacOS/Type
...
all: Makefile Type.app/Contents/PkgInfo Type.app/Contents/Resources/empty.lproj Type.app/Contents/Info.plist $(TARGET)

$(TARGET): ui_mainwindow.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) Type.app/Contents/MacOS/ || $(MKDIR) Type.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Type.pro  /usr/local/Qt4.6/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.6/mkspecs/common/unix.conf \
		/usr/local/Qt4.6/mkspecs/common/mac.conf \
		/usr/local/Qt4.6/mkspecs/common/mac-g++.conf \
		/usr/local/Qt4.6/mkspecs/qconfig.pri \
		/usr/local/Qt4.6/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -spec /usr/local/Qt4.6/mkspecs/macx-g++ -macx -o Makefile Type.pro
...
Type.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) Type.app/Contents || $(MKDIR) Type.app/Contents 
	@$(DEL_FILE) Type.app/Contents/PkgInfo
	@echo "APPL????" >Type.app/Contents/PkgInfo
Type.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) Type.app/Contents/Resources || $(MKDIR) Type.app/Contents/Resources 
	@touch Type.app/Contents/Resources/empty.lproj
	
Type.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) Type.app/Contents || $(MKDIR) Type.app/Contents 
	@$(DEL_FILE) Type.app/Contents/Info.plist
	@sed -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,Type,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.6/mkspecs/macx-g++/Info.plist.app >Type.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Type1.0.0 || $(MKDIR) .tmp/Type1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Type1.0.0/ && $(COPY_FILE) --parents mainwindow.h boshiamy.h const.h .tmp/Type1.0.0/ && $(COPY_FILE) --parents boshiamy.qrc .tmp/Type1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp boshiamy.cpp .tmp/Type1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Type1.0.0/ && (cd `dirname .tmp/Type1.0.0` && $(TAR) Type1.0.0.tar Type1.0.0 && $(COMPRESS) Type1.0.0.tar) && $(MOVE) `dirname .tmp/Type1.0.0`/Type1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Type1.0.0
...
compiler_rcc_make_all: qrc_boshiamy.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_boshiamy.cpp
qrc_boshiamy.cpp: boshiamy.qrc \
		liu-uni.trial.txt
	/Developer/Tools/Qt/rcc -name boshiamy boshiamy.qrc -o qrc_boshiamy.cpp
...
boshiamy.o: boshiamy.cpp boshiamy.h \
		const.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o boshiamy.o boshiamy.cpp

moc_mainwindow.o: moc_mainwindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_mainwindow.o moc_mainwindow.cpp

qrc_boshiamy.o: qrc_boshiamy.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_boshiamy.o qrc_boshiamy.cpp
